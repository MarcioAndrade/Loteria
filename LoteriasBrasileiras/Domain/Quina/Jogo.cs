...
namespace Domain.Quina
{
    public class Jogo : Entity<Jogo>, IJogo
    {
        ...
        public IList<int> Dezenas
        {
            get
            {
                var _dezenas = new List<int> { Dezena_01, Dezena_02, Dezena_03, Dezena_04, Dezena_05 };

                if (Dezena_06.HasValue)
                    _dezenas.Add(Dezena_06.Value);
        ...
        private void Validar()
        {
            RuleFor(d => d.Dezena_01)
                .ExclusiveBetween(0, 81)
                    .WithMessage("A dezena 01 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_02)
                .ExclusiveBetween(0, 81)
                    .WithMessage("A dezena 02 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_03)
                .ExclusiveBetween(0, 81)
                    .WithMessage("A dezena 03 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_04)
                .ExclusiveBetween(0, 81)
                    .WithMessage("A dezena 04 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_05)
                .ExclusiveBetween(0, 81)
                    .WithMessage("A dezena 05 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_06)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_06.HasValue)
                    .WithMessage("A dezena 06 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_07)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_07.HasValue)
                    .WithMessage("A dezena 07 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_08)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_08.HasValue)
                    .WithMessage("A dezena 08 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_09)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_09.HasValue)
                    .WithMessage("A dezena 09 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_10)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_10.HasValue)
                    .WithMessage("A dezena 10 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_11)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_11.HasValue)
                    .WithMessage("A dezena 11 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_12)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_12.HasValue)
                    .WithMessage("A dezena 12 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_13)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_13.HasValue)
                    .WithMessage("A dezena 13 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_14)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_14.HasValue)
                    .WithMessage("A dezena 14 deve ter um número entre 01 e 80");

            RuleFor(d => d.Dezena_15)
                .ExclusiveBetween(0, 81).When(e => e.Dezena_15.HasValue)
                    .WithMessage("A dezena 15 deve ter um número entre 01 e 80");
        }
    }
}